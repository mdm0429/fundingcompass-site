  ...
  <div class="cta-unit__body">
    <div class="cta-unit__metrics">
      <div class="cta-metric">
        ...
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">Up to 95%</div>
      </div>
      <div class="cta-metric">
        <div class="cta-metric__label">Factoring Fee</div>
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">1.5–3.5%/30 days</div>
      </div>
      <div class="cta-metric">
        <div class="cta-metric__label">Min. Monthly Volume</div>
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">$5,000</div>
      </div>
      <div class="cta-metric">
        <div class="cta-metric__label">Non-Recourse</div>
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">Available</div>
      </div>
    </div>
    <div class="cta-unit__footer">
      <div class="cta-unit__best-for">Founded in 1969, Riviera Finance is one of the oldest factoring companies in the US with non-recourse factoring available and a $5,000 monthly minimum — among the lowest in the industry. Ideal for small B2B businesses with creditworthy commercial customers.</div>
      <div class="cta-unit__actions">
        <a href="https://www.rivierafinance.com/invoice-factoring/" class="btn btn--accent btn--md" target="_blank" rel="nofollow noopener">Apply Now</a>
        <a href="https://fundingcompass.guide/providers/riviera-finance-review/" class="btn btn--outline btn--md">Full Review</a>
      </div>
    </div>
  </div>
</div>
...
| Factoring fee | 1.5–3.5% per 30 days |
| Minimum monthly volume | $5,000 |
| Contract type | Month-to-month or term |
| Recourse vs. non-recourse | Non-recourse available |
...
1. Online application at [rivierafinance.com](https://www.rivierafinance.com/invoice-factoring/) or through one of 25+ regional offices
...
| | Riviera Finance | eCapital | BlueVine |
|---|---|---|---|
| Advance rate | Up to 95% | Up to 97% | Up to 90% |
| Factoring fee | 1.5–3.5%/30 days | 0.5–5%/30 days | 0.25–1.7%/week |
| Minimum monthly volume | $5,000 | $10,000 | $500 |
| Non-recourse | Yes | Yes | Recourse only |
| Industries | All B2B | All B2B | B2B + select |
| Regional offices | 25+ | Yes | Online only |
| Founded | 1969 | 2006 | 2013 |
