...
<div class="cta-unit">
  ...
  <div class="cta-unit__body">
    <div class="cta-unit__metrics">
      ...
      <div class="cta-metric">
        <div class="cta-metric__label">Fee From</div>
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">0.69%/30 days</div>
      </div>
      <div class="cta-metric">
        <div class="cta-metric__label">Min. Monthly Volume</div>
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">$10,000</div>
      </div>
      <div class="cta-metric">
        <div class="cta-metric__label">Funding Speed</div>
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">2–4 hours</div>
      </div>
    </div>
    <div class="cta-unit__footer">
      <div class="cta-unit__best-for">Industry-leading advance rates for freight factoring with 2–4 hour funding. Also serves staffing, government contractors, and general B2B through dedicated industry divisions.</div>
      <div class="cta-unit__actions">
        ...
        <a href="https://fundingcompass.guide/providers/ecapital-review/" class="btn btn--outline btn--md">Full Review</a>
      </div>
    </div>
  </div>
</div>
...
Apply directly at [eCapital.com](https://www.ecapital.com/).
