...
<div class="cta-unit">
  ...
  <div class="cta-unit__body">
    <div class="cta-unit__metrics">
      ...
      <div class="cta-metric">
        <div class="cta-metric__label">Funding Amount</div>
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">$3,000–$500,000</div>
      </div>
      <div class="cta-metric">
      ...
      <div class="cta-metric">
        ...
        <div class="cta-metric__value" style="font-variant-numeric: tabular-nums lining-nums;">$7,500</div>
      </div>
    </div>
    <div class="cta-unit__footer">
      <div class="cta-unit__best-for">Published factor rate range and low revenue minimum make Greenbox accessible to smaller businesses. Serves US and Canadian businesses, including high-risk industries many competitors decline.</div>
      <div class="cta-unit__actions">
        ...
        <a href="https://fundingcompass.guide/providers/greenbox-capital-review/" class="btn btn--outline btn--md">Full Review</a>
      </div>
    </div>
  </div>
</div>
...
Effective APR drops significantly the longer the advance takes to repay. Use the [MCA True Cost Calculator](/tools/mca-true-cost-calculator/) to model your specific scenario.
...
1. Online application at [greenboxcapital.com](https://www.greenboxcapital.com/) — approximately 5–10 minutes
2. Upload 3 months of business bank statements or connect bank account
...
6. Funding within 24–48 hours of signed agreement
...
<aside class="related-resources">
  ...
  <ul class="related-resources__list">
    ...
    <li><a href="/providers/bfs-capital-review/">BFS Capital Review 2026</a></li>
  </ul>
</aside>