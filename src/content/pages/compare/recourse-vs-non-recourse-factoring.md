...
<div class="stat-grid stat-grid--2">
  <div class="stat-card">
    <div class="stat-card__label">NON-RECOURSE PREMIUM</div>
    <div class="stat-card__value">0.5–2%</div>
    <div class="stat-card__sub">extra per 30-day period</div>
  </div>
  <div class="stat-card">
    <div class="stat-card__label">PROTECTION TRIGGER</div>
    <div class="stat-card__value">Insolvency only</div>
    <div class="stat-card__sub">not disputes or slow payment</div>
  </div>
</div>
...
<div class="comp-table-wrap">
  <table class="comp-table">
    ...
    <tbody>
      <tr><td class="td-num">$50,000</td><td class="td-num">1% per 30 days</td><td class="td-num">$6,000</td></tr>
      <tr><td class="td-num">$100,000</td><td class="td-num">1% per 30 days</td><td class="td-num">$12,000</td></tr>
...
**Scenario 2 — Non-recourse is worth considering**
...
**Scenario 3 — Neither protects against the real risk**
A B2B technology services company has clients who routinely dispute invoices over delivery timing and scope. The main risk is not customer insolvency — it is invoice disputes. Non-recourse factoring does not help here. Tighter contracts and delivery documentation are the correct risk mitigation, not non-recourse factoring.
...
<aside class="related-resources">
  ...
  <div class="related-resources__recap">
    ...
    <ul>
      <li>Recourse factoring: you buy back unpaid invoices; non-recourse factoring: the factor absorbs loss if your customer becomes legally insolvent — the premium is 0.5–2% per 30-day period</li>
      <li>Non-recourse protection triggers only on verified insolvency (bankruptcy filing) — invoice disputes, slow payment, and payment plans are NOT covered even under non-recourse agreements</li>
      <li>At $100,000/month in factoring volume, a 1% non-recourse premium costs $12,000/year — only worth it if your customers have meaningful insolvency risk</li>
      <li>Triumph Business Capital and Riviera Finance offer non-recourse factoring for qualified accounts; eCapital and RTS Financial are recourse-only</li>
      <li>Before signing, request written definitions of "insolvency," the disputed invoice carve-out, and per-customer coverage caps — these details determine whether non-recourse protection delivers its stated value</li>
    </ul>
  </div>
