...
<div class="stat-grid stat-grid--3">
  <div class="stat-card">
    <div class="stat-card__label">SBA 504 RATE</div>
    <div class="stat-card__value">5.5–7%</div>
    <div class="stat-card__sub">fixed on SBA debenture portion</div>
  </div>
  <div class="stat-card">
    <div class="stat-card__label">SBA 504 TIMELINE</div>
    <div class="stat-card__value">30–90 days</div>
    <div class="stat-card__sub">application to funding</div>
  </div>
  <div class="stat-card">
    <div class="stat-card__label">DOWN PAYMENT</div>
    <div class="stat-card__value">10%</div>
    <div class="stat-card__sub">established business (15–20% for startups)</div>
  </div>
</div>
...
**Process:**
1. Apply with bank or online lender
2. Credit decision in hours to days (under $250K is often same-day)
3. Loan documents signed electronically
4. Funding within 24–48 hours of signing
...
Certified Development Companies (CDCs) facilitate SBA 504 loans in each region. Find your CDC at [sba.gov](https://www.sba.gov/local-assistance/find/).
