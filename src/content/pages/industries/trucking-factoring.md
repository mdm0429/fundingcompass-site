...
<div class="stat-grid stat-grid--3">
  <div class="stat-card">
    ...
    <div class="stat-card__value">90–97%</div>
    <div class="stat-card__sub">of invoice face value</div>
  </div>
  <div class="stat-card">
    <div class="stat-card__label">FUNDING SPEED</div>
    <div class="stat-card__value">2–4 hrs</div>
    <div class="stat-card__sub">after document verification</div>
  </div>
  <div class="stat-card">
...
|---|---|---|---|---|
| [eCapital](/providers/ecapital-review/) | Up to 97% | From 0.69% | Yes | Recourse |
| [Triumph Business Capital](/providers/triumph-business-capital-review/) | Up to 97% | 1.5–3% | Yes | Both options |
| [RTS Financial](/providers/rts-financial-review/) | Up to 97% | 1–3% | Yes | Recourse |
| [OTR Capital](https://www.otrcapital.com/) | Up to 97% | 1.5–3.5% | Yes | Recourse |
| [Bobtail](https://www.bobtail.com/) | Up to 97% | 1.5–3% | No | Recourse |
| [TCI Business Capital](/providers/tci-business-capital-review/) | Up to 95% | 1.5–3.5% | Yes | Both options |
...
<div class="comp-table-wrap">
  <table class="comp-table comp-table--calc">
    <tbody>
      <tr><td>Monthly invoice volume</td><td class="td-num">$40,000</td></tr>
      <tr><td>Advance rate</td><td class="td-num">97%</td></tr>
      <tr><td>Upfront advance</td><td class="td-num">$38,800</td></tr>
      <tr><td>Factoring fee (1.5%)</td><td class="td-num">$600 per 30-day period</td></tr>
      <tr style="font-weight:600;background:var(--surface-tinted)"><td>Net proceeds</td><td class="td-num">$38,200 + reserve release on broker payment</td></tr>
    </tbody>
  </table>
</div>
...
<div class="callout callout--warning">
  <strong class="callout__title">Watch Out</strong>
  <div class="callout__body"><p>Loads billed to brokers with poor credit ratings. Freight factors use broker credit databases (Ansonia, Dun &amp; Bradstreet) to rate each broker. If a broker is flagged, the factor may decline to advance on that load — or advance at a lower rate.</p></div>
</div>
...
<aside class="related-resources">
  ...
  <ul class="related-resources__list">
    ...
    <li><a href="/providers/otr-solutions-review/">OTR Solutions Review</a></li>
    <li><a href="/providers/rts-financial-review/">RTS Financial Review</a></li>
