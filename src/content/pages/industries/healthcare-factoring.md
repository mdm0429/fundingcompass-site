...
<blockquote class="stat-quote">
  <p><strong>Healthcare factoring advances 70–85% of insurance receivables — the lowest advance rate across all industries, reflecting a 5–20% industry-wide claim denial rate.</strong></p>
...
<div class="stat-grid stat-grid--3">
  <div class="stat-card">
    ...
    <div class="stat-card__sub">of insurance receivables</div>
  </div>
  <div class="stat-card">
    <div class="stat-card__label">CLAIM DENIAL RATE</div>
    <div class="stat-card__value">5–20%</div>
    <div class="stat-card__sub">industry-wide average</div>
  </div>
  <div class="stat-card">
    <div class="stat-card__label">MIN. MONTHLY VOLUME</div>
    <div class="stat-card__value">$25–50K</div>
    <div class="stat-card__sub">insurance receivables</div>
  </div>
</div>
...
| Factor | Advance Rate | Fee Per 30 Days | Medicare/Medicaid | HIPAA BAA |
|---|---|---|---|---|
| [PRN Funding](/providers/prn-funding-review/) | 70–85% | 2–5% | Yes | Yes |
| [MedLink Financial](https://www.medlinkfinancial.com/) | 70–85% | 2.5–5% | Yes | Yes |
| [Crestmark](https://www.crestmark.com/) | 75–85% | 2–4.5% | Limited | Yes |
...
Medicare's payment rules add complexity to healthcare factoring. Medicare regulations permit [assignment of Medicare receivables](/glossary/) — but only to a qualified factor and under specific conditions. The factor must be enrolled as a Medicare-approved assignee or collect through you using a "lock box" arrangement.
